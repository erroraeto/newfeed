    ...
    mainNews.forEach(item => {
        ...
        <div class="main__item">
            ...
            <div class="main__item-content">
                <h3 class="main__item-tag">${escapeString(category.name)}</h3>
                <h2 class="main__item-title">${escapeString(item.title)}</h2>
                <p class="main__item-text">${escapeString(item.description)}</p>
                <a class="main__item-source">${escapeString(source.name)}</a>
            </div>
        </div>
    `;
    ...
    smallNews.forEach(item => {
        ...
        <div class="nav__item">
            ...
            <div class="nav__item-info">
                <h3 class="nav__item-data">${escapeString(date)}</h3>
                <a class="nav__item-source" href="#">${escapeString(source.name)}</a>
            </div>
        </div>
    `;
